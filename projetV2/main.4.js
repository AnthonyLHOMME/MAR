...
function start()
{
	...
	// Creates helico
	var vehicle = new Helico(renderingEnvironment.scene) ;

	// Camera setup
	renderingEnvironment.camera[0].position.x = 0 ;
	renderingEnvironment.camera[0].position.y = 0 ;
	renderingEnvironment.camera[0].position.z = 40 ;
